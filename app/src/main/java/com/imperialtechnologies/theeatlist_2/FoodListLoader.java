...
public class FoodListLoader extends AsyncTaskLoader<Cursor> {
    ...
    public Cursor loadInBackground() {
        ...
        Log.d("FoodListLoader", "Fetching foodListCursor");
        Cursor foodListCursor = dbTools.getCursorAllFoodItems();
        Log.d("FoodListLoader", "Cursor retrieved");
    ...
    protected void onStartLoading() {
        ...
        if (mObserver == null) {
            mObserver = new FoodObserver();
            // TODO: register the observer -- What am I supposed to do?
        }
    ...
    protected void onReset() {
        ...
        if (mObserver != null) {
            // TODO: unregister the observer -- yea I don't know what to do about this either
            mObserver = null;
        }
    }
    ...
    private FoodObserver mObserver;
